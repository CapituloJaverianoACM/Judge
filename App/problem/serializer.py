...
class ProblemSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        if validated_data.get('description', False):
            description_serializer = DescriptionSerializer(data=validated_data['description'])
            description_serializer.is_valid(raise_exception=True)
            description_serializer.update(instance.description, validated_data['description'])
        ...
        instance.link_source = validated_data.get('link_source', instance.link_source)
        instance.is_original = validated_data.get('is_original', instance.is_original)
        instance.save()
        return instance
